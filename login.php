...
<head>
	...
	<!-- Style-CSS -->
	<link rel="stylesheet" href="css5/fontawesome-all.css">
	<!-- Font-Awesome-Icons-CSS -->
	<!-- //css files -->
	<!-- web-fonts -->
	<link href="//fonts5.googleapis.com/css?family=Marck+Script&amp;subset=cyrillic,latin-ext" rel="stylesheet">
	<link href="//fonts5.googleapis.com/css?family=Montserrat:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&amp;subset=cyrillic,latin-ext"
	    rel="stylesheet">
	<!-- //web-fonts -->
</head>
...
<body>
  ...
  <div class="video-w3l" data-vide-bg="video5/1">
  <div style="background-color:#d82a4e;">
        <h1>
		...
		<!-- //copyright -->
		<div class="footer" style="background-color:#d82a4e;" >
			<p>&copy; 2018 Video Login Form. All rights reserved | Design by chippy
	...
	<!-- Video js -->
	<script src="js5/jquery.vide.min.js"></script>
	<!-- //Video js -->
